        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                @if (App\Helpers\CommonHelper::isCapable('cattle.index'))
                    <li {{ (Request::routeIs('cattle.*') ? 'class=active' : '') }}>
                        <a href="{{ route('cattle.index') }}">
                            <i class="fa fa-paw"></i> <span>{{__('info.cattle')}}</span>
                        </a>
                    </li>
                @endif

                @if (App\Helpers\CommonHelper::isCapable('cattle_types.index'))
                    <li {{ (Request::routeIs('cattle_types.*') ? 'class=active' : '') }}>
                        <a href="{{ route('cattle_types.index') }}">
                            <i class="fa fa-th"></i> <span>{{__('info.cattle_types')}}</span>
                        </a>
                    </li>
                @endif
                ...
                @if (App\Helpers\CommonHelper::isCapable('breeds.index'))
                    <li {{ (Request::routeIs('breeds.*') ? 'class=active' : '') }}>
                        <a href="{{ route('breeds.index') }}">
                            <i class="fa fa-crosshairs"></i> <span>{{__('info.breeds')}}</span>
                        </a>
                    </li>
                @endif
